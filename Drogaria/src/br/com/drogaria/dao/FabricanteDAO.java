...
public class FabricanteDAO {
	...
	public static void main(String[] args) {
		...
		/*
		 * Fabricante f1 = new Fabricante(); f1.setDescricao("DESCRIÇÃO 1"); Fabricante
		 * f2 = new Fabricante(); f2.setDescricao("DESCRIÇÃO 1");
		 * 
		 ...
		 */
		/*
		 * // BUSCAR POR DESCRIÇÂO Fabricante f1 = new Fabricante();
		 * f1.setDescricao("1");
		 * 
		 * FabricanteDAO fdao = new FabricanteDAO();
		 * 
